        ...
        {["status", "type", "priority", "assignee"].map((name) => {
          ...
          return (
            <select
              ...
              className=" border not-dark:bg-white border-zinc-300 dark:border-zinc-800 outline-none px-3 py-1 rounded text-sm text-zinc-900 dark:text-zinc-200  dark:bg-zinc-900"
            >
