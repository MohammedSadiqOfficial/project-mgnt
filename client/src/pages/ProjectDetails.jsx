...
import { ArrowLeftIcon, PlusIcon, SettingsIcon, BarChart3Icon, CalendarIcon, FileStackIcon, ZapIcon, FolderKanban } from "lucide-react";
...
export default function ProjectDetail() {
    ...
    if (!project) {
        return (
            <div className="p-6 text-center text-zinc-900 dark:text-zinc-200 flex flex-col items-center justify-center min-h-full gap-4">
                <div className="p-4 rounded-full bg-zinc-200 text-zinc-900 dark:text-white dark:bg-zinc-700">
                    <FolderKanban className="size-10"/>
                </div>
                <p className="text-3xl md:text-5xl ">Project not found</p>
